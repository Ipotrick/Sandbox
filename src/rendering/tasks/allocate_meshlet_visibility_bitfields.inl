...
DAXA_INL_TASK_USE_BEGIN(AllocateMeshletVisibilityBase, DAXA_CBUFFER_SLOT1)
DAXA_INL_TASK_USE_BUFFER(u_meshlists, daxa_BufferPtr(MeshList), COMPUTE_SHADER_READ)
...
DAXA_INL_TASK_USE_BUFFER(u_visibility_bitfield_sratch, daxa_BufferPtr(daxa_u32), COMPUTE_SHADER_READ_WRITE)
DAXA_INL_TASK_USE_BUFFER(u_meshlet_visibilities, daxa_RWBufferPtr(EntityVisibilityBitfieldOffsets), COMPUTE_SHADER_WRITE)
