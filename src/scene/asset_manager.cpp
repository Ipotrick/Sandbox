...
auto AssetManager::create_mesh(std::string_view unique_name, aiMesh *aimesh) -> std::pair<u32, Mesh const *>
{
...
auto AssetManager::get_mesh_if_present(std::string_view const &mesh_name) -> std::optional<std::pair<u32, Mesh const *>>
{
...
auto AssetManager::get_or_create_mesh(aiMesh * aimesh) -> std::pair<u32, Mesh const *>
{
