...
static auto free_image_parse_raw_image_data(RawImageData &&raw_data, daxa::Device & device) -> ParsedImageRet
{
    ...
    u32 channel_num = 0u;
    u32 channel_byte_size = 0u;
    switch(image_type)
    {
        case FREE_IMAGE_TYPE::FIT_BITMAP : 
        {
            channel_byte_size = 1u;
            channel_data_type = ChannelDataType::UNSIGNED_INT;
            break;
        }
	    case FREE_IMAGE_TYPE::FIT_UINT16 :
        {
            channel_byte_size = 2u;
            channel_data_type = ChannelDataType::UNSIGNED_INT;
            break;
        }
        ...
        {
            channel_byte_size = 2u;
            channel_data_type = ChannelDataType::SIGNED_INT;
            break;
        }
	    case FREE_IMAGE_TYPE::FIT_UINT32 :
        {
            channel_byte_size = 4u;
            channel_data_type = ChannelDataType::UNSIGNED_INT;
            break;
        }
        ...
        {
            channel_byte_size = 4u;
            channel_data_type = ChannelDataType::FLOATING_POINT;
            break;
        }
        ...
        default:
            return AssetProcessor::AssetLoadResultCode::ERROR_UNSUPPORTED_CHANN
    }
...
// call this ONLY when linking with FreeImage as a static library
    ...
    auto AssetProcessor::load_texture(Scene & scene, u32 texture_manifest_index)->AssetLoadResultCode
    {
        ...
        else
        {
            ...
            parsed_data = free_image_parse_raw_image_data(std::move(raw_image_data), _device);
        }
    }
    ...
    auto AssetProcessor::record_gpu_load_processing_commands()->daxa::ExecutableCommandList
    {
        ...
        for (MeshUpload &mesh_upload : _upload_mesh_queue)
        {
            ...
            auto const gpu_meshes_buffer = mesh_upload.scene->_t_meshes.get_state().buffers[0];
